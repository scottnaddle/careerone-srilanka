...
{{--        <p class="text-2xl text-[#464559] dark:text-white font-semibold">OJT Information</p>--}}
        <div class="py-6">
            <x-breadcrumb :items="[
                ...
                ['label' => trans('system.form.button.edit'), 'url' => '#'],
            ]" />
        </div>
        <div class="bg-white dark:bg-[#1E1E1E] rounded-xl px-4 py-5 flex flex-col gap-5">
            <div class="flex flex-col gap-4">
                <form class="flex flex-col gap-6"
                    action="{{ route('company.job-support.ojt-list.update', ['slug' => $ojt->slug]) }}" method="POST"
                    ...
                    <div>
                        ...
                        <input type="text" id="title" name="title" value="{{ $ojt->title }}"
                    ...
                    <div class="flex justify-between gap-6">
                        <div class="w-full md:w-1/3">
                            ...
                            <select name="company_id" id="company_id"
                                    class="border border-gray-300 text-[#201F36] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#1E1E1E] dark:border-white dark:placeholder-text-white dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 font-semibold" required>
                            ...
                            <div class="flex gap-4">
                                ...
                                <div class="flex items-center">
                                    <input id="gender-{{$gender->code_id}}"
                                           ...
                                           {{ in_array($gender->code_id, old('gender', optional($ojt)->gender ? json_decode($ojt->gender, true) : [])) ? 'checked' : '' }}
                                           name="gender[]"
...
{{--                                <div class="w-1/2">--}}
{{--                                    <input type="text" id="min_age" name="min_age" value="{{ $ojt->min_age }}"--}}
{{--                                        minlength="2" maxlength="2"--}}
{{--                                        class="border border-gray-300 text-[#201F36] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#1E1E1E] dark:border-white dark:placeholder-text-white dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 {{$ojt->age_limitation ? 'cursor-not-allowed bg-gray-100' : ''}}" {{$ojt->age_limitation ? 'disabled' : ''}} />--}}
{{--                                    @if ($errors->has('min_age'))--}}
{{--                                        <span class="text-red-600 text-xs p-0 m-0">{{ $errors->first('min_age') }}</span>--}}
{{--                                    @endif--}}
{{--                                </div>--}}
{{--                                <div class="w-1/2">--}}
{{--                                    <input type="text" id="max_age" name="max_age" value="{{ $ojt->max_age }}"--}}
{{--                                        minlength="2" maxlength="2"--}}
{{--                                        class="border border-gray-300 text-[#201F36] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#1E1E1E] dark:border-white dark:placeholder-text-white dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 {{$ojt->age_limitation ? 'cursor-not-allowed bg-gray-100' : ''}}"--}}
{{--                                        placeholder="" {{$ojt->age_limitation ? 'disabled' : ''}} />--}}
...
{{--                            </div>--}}
{{--                            <div class="flex items-center">--}}
{{--                                <input id="age_limitation" type="checkbox" {{$ojt->age_limitation ? 'checked' : ''}} value="1" name="age_limitation"--}}
                            ...
                            <div class="flex gap-6 mb-2">
                                <div class="w-full">
                                    <input type="text" id="min_work_experience" name="min_work_experience"
                                           value="{{ $ojt->min_work_experience }}"
                                           class="border border-gray-300 text-[#201F36] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#1E1E1E] dark:border-white dark:placeholder-text-white dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 {{$ojt->work_experience_limitation ? 'cursor-not-allowed bg-gray-100' : '' }}"
                                           placeholder="" {{$ojt->work_experience_limitation ? 'disabled' : 'required'}} />
...
{{--                                </div>--}}
                            ...
                            <div class="flex items-center">
                                <input id="not_limitation_work_experience" type="checkbox" {{$ojt->work_experience_limitation ? 'checked' : ''}} value="1" name="work_experience_limitation"
                                       class="rounded-full w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-white">
                        ...
                        <div>
                            ...
                            <input name="required_skills" id="required_skills" value="{{$ojt->required_skills}}"
                                   class="border border-gray-300 text-[#201F36] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#1E1E1E] dark:border-white dark:placeholder-text-white dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Require skills">
                            ...
                            <div class="flex gap-6">
                                <div class="w-1/2">
                                    <div class="relative">
                                        ...
                                        <input datepicker datepicker-autoselect-today
                                            datepicker-format="yyyy-mm-dd"
                                            value="{{ $ojt->application_starttime ? \Carbon\Carbon::parse($ojt->application_starttime)->format('Y-m-d') : 0 }}"
                                ...
                                <div class="w-1/2">
                                    <div class="relative">
                                        ...
                                        <input datepicker datepicker-autoselect-today
                                            datepicker-format="yyyy-mm-dd"
                                            value="{{ $ojt->application_endtime ? \Carbon\Carbon::parse($ojt->application_endtime)->format('Y-m-d') : 0 }}"
                                            datepicker-min-date="{{ \Carbon\Carbon::parse(now())->format('Y-m-d') }}"
                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="hr_name" name="hr_name" value="{{ $ojt->hr_name }}"
                                class="border border-gray-300 text-[#201F36] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#1E1E1E] dark:border-white dark:placeholder-text-white dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 "
                                placeholder="" />
                        ...
                        <div class="">
                            ...
                            <input type="email" id="email" name="hr_email" value="{{ $ojt->hr_email }}"
                                class="border border-gray-300 text-[#201F36] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#1E1E1E] dark:border-white dark:placeholder-text-white dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 " />
                        ...
                        <div>
                            ...
                            <input type="text" id="hr_contact_info" name="hr_contact_info"
                                value="{{ $ojt->hr_contact_info }}"
                                class="border border-gray-300 text-[#201F36] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#1E1E1E] dark:border-white dark:placeholder-text-white dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 " />
                    ...
                    @if( optional($ojt)->id )
                        @php
                        $states = \App\Enums\JobStatusEnum::getAllStatus();
                        @endphp
                        {{-- Change status --}}
                        <div class="mb-3">
                            <label for="status" class="block mb-2 text-sm font-medium text-[#706F81] dark:text-white">{{ __('company.status') }}
                                <span class="text-red-700">*</span></label>
                            <div class="flex">
                                <div class="w-full">
                                    <select id="status"
                                        ...
                                        @foreach( $states as $k => $status)
                                            <option {{ old('status', optional($ojt)->status) == $k ? 'selected' : '' }}
                    ...
                    @endif
                    <div class="flex gap-3 items-center justify-end p-4 md:p-5">

                        <a href="{{ route('company.job-support.ojt-list.list') }}"
                            class="w-fit text-center text-gray-500 bg-[#EDEDED] hover:bg-gray-500 hover:text-black focus:ring-4 focus:ring-blue-300 font-medium rounded-full
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".btn-delete").click(function() {
                ...
                $("#delete-modal a").attr('href', '/company/job-support/ojt-list/attachment/delete/' + $(this).data(
                    'id') + '/' + $(this).data('ojt-id'));
            });
