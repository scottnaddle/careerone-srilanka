                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-base font-semibold text-gray-900 truncate flex items-center">
                            ...
                            {!! $contenData->status == \App\Enums\StatusEnumsManagement::APPROVED->value
                                ? "<span style=' color: #4984F6; padding: 0.2rem 0.4rem; border-radius: 0.25rem; font-weight:600; display: inline-flex; align-items: center;'>
                                ...
                                : ($contenData->status == \App\Enums\StatusEnumsManagement::NON_APPROVAL->value
                                    ? "<span style=' color: #F34550; padding: 0.2rem 0.4rem; border-radius: 0.25rem; font-weight:600; display: inline-flex; align-items: center;'>
                                                                                                <svg class='h-4 w-4 inline-block mr-1' width='24' height='24' viewBox='0 0 24 24' stroke-width='2' stroke='currentColor' fill='none' stroke-linecap='round' stroke-linejoin='round'>
                                                                                                    <path stroke='none' d='M0 0h24v24H0z'/>
                                    ...
                                    : "<span style=' color: #5a5252; padding: 0.2rem 0.4rem; border-radius: 0.25rem; font-weight:600; display: inline-flex; align-items: center;'>
                                         <svg class='h-4 w-4 inline-block mr-1' width='24' height='24' viewBox='0 0 24 24' stroke-width='2' stroke='currentColor' fill='none' stroke-linecap='round' stroke-linejoin='round'>
...
{{--                        </span>--}}
{{--                        @if($event->place)--}}
{{--                        <span class="dark:text-white">Place: <span class="font-semibold">{{$event->place}}</span></span>--}}
{{--                        @endif--}}
{{--                        <figure class="custom-width-image">--}}
{{--                            <img src="{{ asset( $event->thumbnail) }}" alt="Event image" class="w-72 rounded-xl">--}}
...
{{--            </x-filament-panels::form>--}}
            ...
            @endif
            <div class="mt-auto flex justify-end space-x-2 pb-4">
                @if(auth('admin')->user()->hasRole('super_admin'))
                    @if ($contenData->status == 0 || $contenData->status == 2)
                        <div class="mr-2">
                    ...
                    @endif
                    @if ($contenData->status == 0 || $contenData->status == 1)
                        <div>
