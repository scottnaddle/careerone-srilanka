...
class NvqCoursesPolicy
{
    ...
    {
        return $adminUser->can('view_any_api::n::v::q::courses');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, NvqCourses $nvqCourses): bool
    {
        return $adminUser->can('view_api::n::v::q::courses');
    }
    ...
    {
        return $adminUser->can('create_api::n::v::q::courses');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, NvqCourses $nvqCourses): bool
    {
        return $adminUser->can('update_api::n::v::q::courses');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, NvqCourses $nvqCourses): bool
    {
        return $adminUser->can('delete_api::n::v::q::courses');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, NvqCourses $nvqCourses): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, NvqCourses $nvqCourses): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, NvqCourses $nvqCourses): bool
    {
