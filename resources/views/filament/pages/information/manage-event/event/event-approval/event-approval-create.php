...
<!--                        <span class="block font-semibold text-center mb-4 text-2xl font-medium">{{$this->detailid->fullName}}</span>-->
                        ...
                        <div class="mt-4 flex">
                            <button type="button" wire:click="closeModal"
                                class="bg-white border text-sm font-semibold text-gray-700 mr-2 px-4 py-2 rounded rounded-xl w-1/2">
                                {{ __('Cancel') }}
                            </button>
                            <button type="button" wire:click="approveItem"
                                class="bg-primary text-white px-4 py-2 rounded rounded-xl w-1/2 font-semibold text-sm">
                                {{ __('Confirm') }}
                            </button>
                        </div>
