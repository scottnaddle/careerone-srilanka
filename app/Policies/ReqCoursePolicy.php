...
class ReqCoursePolicy
{
    ...
    {
        return $adminUser->can('view_any_api::r::e::q::courses');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, ReqCourse $reqCourse): bool
    {
        return $adminUser->can('view_api::r::e::q::courses');
    }
    ...
    {
        return $adminUser->can('create_api::r::e::q::courses');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, ReqCourse $reqCourse): bool
    {
        return $adminUser->can('update_api::r::e::q::courses');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, ReqCourse $reqCourse): bool
    {
        return $adminUser->can('delete_api::r::e::q::courses');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, ReqCourse $reqCourse): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, ReqCourse $reqCourse): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, ReqCourse $reqCourse): bool
    {
