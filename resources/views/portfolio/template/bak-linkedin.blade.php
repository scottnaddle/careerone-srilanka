...
<head>
    ...
    <script src="https://unpkg.com/flowbite-datepicker@latest/dist/flowbite-datepicker.min.js"></script> @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>
            ...
            <div class="px-4 py-4 flex flex-col gap-6">
                <div class="bg-white dark:bg-[#1E1E1E] flex w-full items-center  justify-center rounded-xl shadow-custom-light dark:shadow-custom-dark border border-gray-300 dark:border-white">
                    <div class="w-full bg-white dark:bg-[#1E1E1E] transform duration-200 easy-in-out rounded-xl">
                        <div class=" h-64 overflow-hidden">
                            <img class="w-full rounded-t-xl" src="https://images.unsplash.com/photo-1605379399642-870262d3d051?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=2000&q=80" alt="" />
                        </div>
                        <div class="flex justify-start px-5  -mt-12">
                            <img class="h-32 w-32 bg-white p-1 rounded-full   " src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=2000&q=80" alt="" />
                        </div>
                        <div class="pb-5">
                            <div class="text-left px-5">
                                <p class="text-[#464559] dark:text-white text-2xl lg:text-3xl font-semibold" id="trainee-name-heading">Your full name</p>
                                <p class="text-[#706F81] dark:text-white " id="trainee-short-bio">"I am the best of electric"</p>
                                <p class="text-[#91919A] dark:text-white" id="expertise_heading_block"> Web Designer | NVQ5 | Tourism </p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="flex gap-6 flex-col lg:flex-row">
                            <div class="flex flex-col gap-4">
                                <div class="flex gap-4">
                                    ...
                                    <span class="text-sm text-[#464559] dark:text-white" id="trainee-name">Your full name</span>
                                </div>
                                <div class="flex gap-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            ...
                            <div class="flex flex-col gap-4">
                                <div class="flex gap-4">
                                    ...
                                    <span class="text-sm text-[#464559] dark:text-white" id="trainee-email">user@email.com</span>
                                </div>
                                <div class="flex gap-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                    ...
                                    <span class="text-sm text-[#464559] dark:text-white" id="trainee-address">37403 Haven Locks Predovichaven, KY 12472-2496</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white dark:bg-[#1E1E1E] flex w-full items-center p-5 rounded-xl shadow-custom-light dark:shadow-custom-dark border border-gray-300 dark:border-white">
                    <div class="flex flex-col gap-4">
                        ...
                        <p class="text-lg text-[#706F81] dark:text-white" id="trainee-basic-information">Odit veniam error reiciendis aperiam impedit similique saepe. Voluptatem recusandae occaecati fuga laboriosam et ipsam nam. Odio officiis qui est harum.</p>
                    </div>
                </div>
                                ...
                                <div class="flex  flex-col gap-4">
                                    <div class="flex gap-4 items-baseline">
                                        ...
                                        <div class="flex flex-col gap-2">
                                            <p>
                                                <span class="text-[#464559] text-xl font-semibold dark:text-white">B.Sc in debitis </span>
                                                <span class="text-[#706F81]  dark:text-white"> (Green-Wunsch)</span>
                                            </p>
                                            <p>
                                                <span class="text-[#91919A] dark:text-white">2008 - 1978</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="flex gap-4 items-baseline">
                            ...
                            <div id="certificate_block">
                                <div class="flex flex-col gap-4">
                                    <div class="flex gap-4 items-baseline">
                                        ...
                                        <div class="flex flex-col gap-2">
                                            <p>
                                                <span class="text-[#464559] text-xl font-semibold dark:text-white">molestiae Certification</span>
                                                <span class="text-[#706F81] dark:text-white">(Level 3)</span>
                                            </p>
                                            <p>
                                                <span class="text-[#91919A] dark:text-white">1991 - 2010</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="flex gap-4 items-baseline">
                        ...
                        <div id="experience">
                            <ol class="relative border-s border-gray-200 dark:border-white">
                                <li class="mb-10 ms-4">
                                    ...
                                    <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-white">February 2022</time>
                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Application UI code in Tailwind CSS</h3>
                                    <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Get access to over 20+ pages including a dashboard layout, charts, kanban board, calendar, and pre-order E-commerce & Marketing pages.</p>
                                </li>
                                <li class="mb-10 ms-4">
                                    <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-white"></div>
                                    <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-white">March 2022</time>
                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Marketing UI design in Figma</h3>
                                    <p class="text-base font-normal text-gray-500 dark:text-gray-400">All of the pages and components are first designed in Figma and we keep a parity between the two versions even as we update the project.</p>
                                </li>
                                <li class="ms-4">
                                    <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-white"></div>
                                    <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-white">April 2022</time>
                            ...
                            <div class="flex  flex-wrap gap-4" id="expertise_block">
                                <div class="flex flex-col gap-4">
                                    <div class="flex gap-4 items-baseline">
                                        ...
                                        <div class="flex flex-col gap-2">
                                            <p>
                                                <span class="text-[#464559] text-xl font-semibold dark:text-white">Administration</span>
                                            </p>
                                            <p>
                                                <span class="text-[#91919A] dark:text-white">Human Resources Administrator at Point Avenue</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="flex gap-4 items-baseline">
                    ...
                    <div class="bg-white dark:bg-[#1E1E1E] flex flex-col gap-4 w-full shadow-custom-light dark:shadow-custom-dark p-5 rounded-xl border border-gray-300 dark:border-white">
                        ...
                        <div class="flex  flex-wrap gap-4" id="language_block">
                            <div class="flex flex-wrap gap-4">
                                <label class="text-[#CF9090] bg-[#FFF7F7] dark:bg-[#282828] px-2 py-1 font-semibold rounded-lg">English</label>
                                <label class="text-[#CF9090] bg-[#FFF7F7] dark:bg-[#282828] px-2 py-1 font-semibold rounded-lg">HSK</label>
                            </div>
                        </div>
                    </div>
                </div>
