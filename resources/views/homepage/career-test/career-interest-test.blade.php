@php
    ...
    $requireNIC = $isTrainee; // Only trainees are required to provide NIC
@endphp
<!doctype html>
<html lang="en">
<head>
    ...
    <script type="application/javascript">
        ...
        function checkNIC(e) {
            ...
            const nic = $("input[id='personNIC']").val().trim();
            const isTrainee = {{ $isTrainee ? 'true' : 'false' }}; // Passed from PHP
            ...
            // If not a trainee, skip NIC validation
            return true;
        }
