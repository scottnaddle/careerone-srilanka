    ...
    <div class="flex flex-col gap-9 mt-6">
        ...
        <div
            ...
            <x-filament::breadcrumbs :breadcrumbs="[
                ...
                'javascript:void(1)' => 'Notice',
                'javascript:void(2)' => 'Notice List',
            ]" />
            {{-- <div class="flex items-center">
                <label for="status" class="text-lg font-semibold text-[#464559]">Notice</label>
            </div> --}}
                    ...
                    <div id="content-request" class="content-page active">
                        ...
                        <div class="flex items-center justify-between mt-4 mb-4">
                            <div class="flex gap-2">
                                <a href="/admin/information/notice/create">
                                    <button id="recent-button" style="background-color: #3B82F6; color:#ffffff"
                                        ...
                                        {{ __('admin/dashboard.notice.new_notice') }}
