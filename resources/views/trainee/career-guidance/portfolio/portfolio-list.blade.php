                    ...
                    <div class="flex flex-col gap-2 w-full">
                        ...
                        <div class="flex flex-col md:flex-row gap-4 justify-between w-full">
                            ...
                            <div class="flex justify-end gap-4">
                                ...
                                <a href="{{route('trainee.career-guidance.portfolios.edit')}}"  class="text-primary text-xs md:text-sm flex items-center gap-1 hover:underline"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
            ...
            @empty
                <div class="flex flex-col gap-4 justify-center items-center">
                    ...
                    <div class="flex flex-col lg:flex-row lg:justify-between gap-4">
                        <a href="{{route('trainee.career-guidance.portfolios.create')}}" class="text-white w-full xl:w-fit bg-[#4984F6] hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 rounded-full
