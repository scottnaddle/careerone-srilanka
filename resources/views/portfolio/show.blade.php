...
@endphp
    <div class="border rounded mt-6">
        <div class="h-16 bg-[#323B49] sticky top-0 w-full flex items-center z-10 px-6 rounded-t no-print shadow-md border-b border-[#434F61] z-30">
            <div class="mx-auto max-w-[1200px] flex justify-between items-center w-full">
                ...
                <div class="flex justify-end gap-3 items-center">
                    <a href="{{route('trainee.career-guidance.portfolio.export-portfolio',['pid' => $portfolio->id])}}" target="_blank" class="flex items-center gap-2 px-4 py-1.5 bg-white/10 hover:bg-white/20 border border-white/20 rounded-full text-white text-[13px] font-semibold transition-all duration-300 shadow-sm">
        ...
        <div class="max-w-[1200px] mx-auto bg-white dark:bg-[#1E1E1E] my-6 rounded-xl shadow-md overflow-hidden border border-gray-200 dark:border-gray-800 portfolio-container">
