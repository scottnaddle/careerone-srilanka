        ...
        <div class="flex flex-col gap-6 p-4 ">
            ...
            <x-filament-panels::form wire:submit="authenticate">
                ...
                <div class="grid grid-cols-1  tvec-information">
                        ...
                        <div class="flex flex-col gap-4 w-full h-full">
                            ...
                            <div class="flex  flex-col gap-4 w-full h-full" id="course_block">
                                ...
                                @foreach ($this->traineeInformation as $item)
                                    ...
                                    <div class="flex flex-col gap-2"><p class="dark:text-white"><span class="text-xl font-semibold">{{$item->INSTITUTE->INSTITUTE_NAME}}</span> <span>(Industry sector: {{$item->COURSE->INDUSTRY_SECTOR}} )</span></p>
                                        <p draggable="false" class="dark:text-white"><span class="font-semibold">Course name: {{$item->COURSE->COURSE_NAME}}</span> <span class="text-sm">({{$item->COURSE->START_DATE}} - {{$item->COURSE->END_DATE}})</span></p></div>
                                </div>
                                @endforeach
                                @endif
                            </div>
                    ...
                    <p class="text-lg font-semibold text-blue-500 leading-6 truncate pt-5 pb-5" id="nvq_type">NVQ Qualification</p>
                    <div
                        class="example-information bg-white dark:bg-[#1E1E1E] flex w-full items-center p-5 rounded-xl shadow-custom-light dark:shadow-custom-dark border border-gray-300 dark:border-white">
                        <div class="flex flex-col gap-4 w-full h-full">
                            ...
                            <div class="flex flex-col gap-4 w-full h-full" id="qualification_block">
                                ...
                                <div class="flex flex-col gap-2" bis_skin_checked="1">
                                    <p>
                                        <span class="text-[#464559] text-xl font-semibold dark:text-white">{{$item->NVQ_QUALIFICATION->QUALIFICATION_NAME}}</span>
                                        <span class="text-[#706F81] dark:text-white">({{$item->NVQ_QUALIFICATION->QUALIFICATION_LEVEL}})</span>
                                    </p>
                                    <p>
                                        <span class="text-[#91919A] dark:text-white">{{$item->NVQ_QUALIFICATION->EFFECTIVE_DATE}}</span>
                                    </p>
                                </div>
                                @endforeach
                                @endif
...
{{--                                <h2 class="text-medium font-semibold">{{ __('Trainee Reject') }}</h2>--}}
