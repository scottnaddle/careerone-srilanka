...
class FaqArticlePolicy
{
    ...
    {
        return $adminUser->can('view_any_information::f::a::q::article');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, FaqArticle $faqArticle): bool
    {
        return $adminUser->can('view_information::f::a::q::article');
    }
    ...
    {
        return $adminUser->can('create_information::f::a::q::article');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, FaqArticle $faqArticle): bool
    {
        return $adminUser->can('update_information::f::a::q::article');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, FaqArticle $faqArticle): bool
    {
        return $adminUser->can('delete_information::f::a::q::article');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, FaqArticle $faqArticle): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, FaqArticle $faqArticle): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, FaqArticle $faqArticle): bool
    {
