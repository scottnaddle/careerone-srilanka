...
@push('js')
    ...
    <script type="module">
        ...
        function showTab(n) {
            ...
            // Nếu là Tab Confirmation -> Fill dữ liệu Summary
            if (n === 2) {
        ...
        function validateFormTab(tabIndex) {
            ...
            // Rule ở Tab 1 (Manual) -> Bắt buộc check NIC thông qua regex
            if (tabIndex === 0) {
            ...
            // Kiểm tra password rules ở Tab 2
            if (tabIndex === 1) {
        ...
        $(document).ready(function() {
            ...
            // Lắng nghe thao tác người dùng lên toàn bộ form
