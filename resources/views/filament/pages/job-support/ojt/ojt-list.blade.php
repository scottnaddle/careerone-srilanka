<div>
    ...
    <script type="module" src="https://cdn.jsdelivr.net/npm/flowbite@2.5.2/dist/flowbite.min.js"></script>
    <div class="p-6 space-y-6 bg-white mt-4 rounded-xl">
        <div class="flex items-center">
{{--            <label for="status" class="text-lg font-semibold text-[#464559]">OJT List</label>--}}
        <x-filament::breadcrumbs :breadcrumbs="[
            '/admin/overview' =>  'Admin',
            '#' =>  'Job Support',
            '/admin/o-j-t-s' => 'OJT List',
        ]" />
        </div>
