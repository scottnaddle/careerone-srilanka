...
class NoticeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('company.informations.notice.index', compact('listNotices', 'listNoticeTypeEnum'));
    }
    ...
    public function show($id)
    {
        ...
        return view('company.informations.notice.notice-show', compact('notice'));
    }
