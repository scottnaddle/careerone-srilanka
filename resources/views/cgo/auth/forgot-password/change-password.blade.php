    ...
    <div class="max-w-lg mx-auto w-screen py-24">
        <div
            ...
            <div class="flex flex-col gap-6">
                <a href="{{ route('cgo.auth.register') }}"
                    ...
                    <span class="text-xl font-semibold text-gray-900 dark:text-white">{{trans('auth.cgo_sign_up')}}</span>
                </a>
                ...
                @endif
                <form class="leading-5" action="{{ route('cgo.auth.postResetPassword') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email') }}"
                            class="bg-gray-50 border border-gray-300 py-2 px-4 text-gray-900 sm:text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full dark:border-white dark:placeholder-white dark:text-white">
                        @if ($errors->has('email'))
