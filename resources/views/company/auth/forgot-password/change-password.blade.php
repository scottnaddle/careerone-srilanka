        ...
        <div
            ...
            <div class="flex flex-col gap-6">
                <a href="{{ route('company.auth.register') }}"
                    ...
                    <span class="text-xl font-semibold text-gray-900 dark:text-white">{{trans('auth.company_sign_up')}}</span>
                </a>
                ...
                @endif
                <form class="leading-5" action="{{ route('company.auth.postResetPassword') }}" method="POST">
                    @csrf
