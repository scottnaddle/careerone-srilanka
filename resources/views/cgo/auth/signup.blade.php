...
@push('js')
    ...
    <script>
        ...
        function showTab(n) {
            ...
            // Nếu là TAB 3 (Confirmation) -> Render dữ liệu xem lại
            if (n === 2) {
                ...
                // Gọi ngay hàm kiểm tra khi sang tab 3
        ...
        window.nextPrev = function(n) {
            // Validation kiểm tra nếu nhấn "Next"
        ...
        function validateFormTab(tabIndex) {
            let tabs = document.querySelectorAll(".tab-content");
            // Kiểm tra các trường có thuộc tính HTML5 required
            ...
            // Kiểm tra thủ công dropdown select2 ở Tab 0
            if (tabIndex === 0) {
            ...
            // Kiểm tra quy tắc password ở tab 1
            if (tabIndex === 1) {
    ...
    <script type="module">
        $(document).ready(function() {
            ...
            // Lọc dữ liệu Telephone (Thay thế hàm cũ dễ gây lỗi trống dữ liệu)
            $('input[name="telephone"]').on('input', function() {
                let value = $(this).val().replace(/\D/g, ''); // Xóa ký tự không phải số
                if (value.length > 0 && value.charAt(0) !== '0') {
                    value = ''; // Nếu số đầu không phải 0 thì clear để người dùng nhập lại từ đầu
                }
                $(this).val(value.substring(0, 10)); // Giới hạn 10 số
            });
            ...
            // Vô hiệu hoá/ Kích hoạt nút Submit an toàn bằng selector theo thuộc tính name
            ...
            // Gọi lần đầu để setup form
            window.toggleSignUpButton();

            // Lắng nghe thao tác người dùng lên toàn bộ trường dữ liệu
        ...
        // Phản hồi trực quan Validate Password
