...
@section('title', 'CGO - Job support - OJT List - OJT Registration')
@push('css')
    <style>
...
{{--        <p class="text-2xl text-[#464559] dark:text-white font-semibold">{{ trans('company.job_support.ojt_list.ojt_registration.root') }}</p>--}}
        <div class="py-6">
            <x-breadcrumb :items="[
                ...
                ['label' => 'OJT registration', 'url' => '#']
            ]" />
        </div>
        <div class="bg-white dark:bg-[#1E1E1E] rounded-xl px-4 py-5 flex flex-col gap-5">
            <div class="flex flex-col gap-4">
                <form class="flex flex-col gap-6" action="{{ route('cgo.job-support.ojt-list.postRegistration') }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="flex flex-col gap-6">
                        <p class="text-xl text-[#464559] dark:text-white font-semibold">OJT details</p>
                        <div>
                            <label for="" class="block mb-2 text-sm font-medium text-[#706F81] dark:text-white">{{ trans('company.job_support.ojt_list.ojt_registration.title') }}
                        ...
                        <div class="flex justify-between gap-6">
                            ...
                            <div class="w-full md:w-1/3">
                                ...
                                <input type="number" min="1" id="number_of_recruitments" name="number_of_recruitments" value="{{ old('period') }}"
                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <div>
                            <label for=""
                                class="block mb-2 text-sm font-medium text-[#706F81] dark:text-white">{{ trans('company.job_support.ojt_list.ojt_registration.application_requirements.gender.root') }}<span
                                    class="text-red-700">*</span></label>
                            <div class="flex gap-4">
                                @foreach(getCodeList('gender') as $gender)
                                    <div class="flex items-center">
                                        <input id="gender-{{$gender->code_id}}" type="radio" value="{{$gender->code_id}}" name="gender" required
                            ...
                            <div class="flex gap-6 mb-2">
                                <div class="w-1/2">
                                    <input type="text" id="min_age" name="min_age" value="{{ old('min_age') }}"
                                        ...
                                        class="border border-gray-300 text-[#201F36] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#1E1E1E] dark:border-white dark:placeholder-text-white dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 placeholder:font-medium font-medium" placeholder="Min age" />
                    ...
                    <div>
                        ...
                        <input name="required_skills" id="required_skills"
