...
class ViewAdmin extends ViewRecord
{
    ...
    protected function getHeaderActions(): array
    {
        ...
        // Only show the assign-role action if the user is super_admin
        ...
        // Add the approve action if not yet verified
    ...
    // Keep the old methods if needed
