...
class QNAPolicy
{
    ...
    {
        return $adminUser->can('view_any_information::q::a');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, QNA $qNA): bool
    {
        return $adminUser->can('view_information::q::a');
    }
    ...
    {
        return $adminUser->can('create_information::q::a');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, QNA $qNA): bool
    {
        return $adminUser->can('update_information::q::a');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, QNA $qNA): bool
    {
        return $adminUser->can('delete_information::q::a');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, QNA $qNA): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, QNA $qNA): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, QNA $qNA): bool
    {
