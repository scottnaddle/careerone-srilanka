...
@endpush
@section('content')
    {{-- <p class="text-3xl py-4 text-[#464559] font-semibold dark:text-white">{{ trans('system.information.event.title') }}</p> --}}
    @if(activeGuard() != null)
    <div class="py-6">
        <x-breadcrumb :items="[
            ['label' => trans('system.menu.home'), 'url' => route('homepage')],
            ['label' => trans('system.menu.information.root'), 'url' => '#'],
            ['label' => trans('system.information.event.event_list'), 'url' => route('informations.events.event')],
            ['label' => trans('system.information.event.form.details'), 'url' => route('informations.events.event')],
        ]" />
    </div>
    @else
        <div class="py-6">
            ...
            ['label' => trans('system.menu.home'), 'url' => route('homepage')],
            ['label' => trans('system.menu.information.root'), 'url' => '#'],
            ['label' => trans('system.information.event.public_event_list'), 'url' => '/public-event'],
            ['label' => trans('system.information.event.form.details'), 'url' => route('informations.events.event')],
        ]" />
        </div>
    @endif
...
{{--                    <img src="{{ asset( $event->thumbnail) }}" class="rounded-xl object-cover h-full lg:h-48" alt="">--}}
{{--                </figure>--}}

{{--            </div>--}}
{{--            <div class="ck-content whitespace-nowrap dark:text-white bg-white dark:bg-white p-4 rounded-xl" data-bs-theme="light">--}}
