...
class NewLetterPolicy
{
    ...
    {
        return $adminUser->can('view_any_newsletter');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, NewLetter $newLetter): bool
    {
        return $adminUser->can('view_newsletter');
    }
    ...
    {
        return $adminUser->can('create_newsletter');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, NewLetter $newLetter): bool
    {
        return $adminUser->can('update_newsletter');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, NewLetter $newLetter): bool
    {
        return $adminUser->can('delete_newsletter');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, NewLetter $newLetter): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, NewLetter $newLetter): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, NewLetter $newLetter): bool
    {
