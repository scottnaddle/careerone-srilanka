...
class MenuPolicy
{
    ...
    {
        return $adminUser->can('view_any_menu');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, Menu $menu): bool
    {
        return $adminUser->can('view_menu');
    }
    ...
    {
        return $adminUser->can('create_menu');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, Menu $menu): bool
    {
        return $adminUser->can('update_menu');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, Menu $menu): bool
    {
        return $adminUser->can('delete_menu');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, Menu $menu): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, Menu $menu): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, Menu $menu): bool
    {
