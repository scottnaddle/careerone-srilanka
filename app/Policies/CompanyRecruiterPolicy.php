...
class CompanyRecruiterPolicy
{
    ...
    {
        return $adminUser->can('view_any_company::recruiter::approval');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, CompanyRecruiter $companyRecruiter): bool
    {
        return $adminUser->can('view_company::recruiter::approval');
    }
    ...
    {
        return $adminUser->can('create_company::recruiter::approval');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, CompanyRecruiter $companyRecruiter): bool
    {
        return $adminUser->can('update_company::recruiter::approval');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, CompanyRecruiter $companyRecruiter): bool
    {
        return $adminUser->can('delete_company::recruiter::approval');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, CompanyRecruiter $companyRecruiter): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, CompanyRecruiter $companyRecruiter): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, CompanyRecruiter $companyRecruiter): bool
    {
