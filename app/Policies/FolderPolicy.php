...
class FolderPolicy
{
    ...
    {
        return $adminUser->can('view_any_folder');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, Folder $folder): bool
    {
        return $adminUser->can('view_folder');
    }
    ...
    {
        return $adminUser->can('create_folder');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, Folder $folder): bool
    {
        return $adminUser->can('update_folder');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, Folder $folder): bool
    {
        return $adminUser->can('delete_folder');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, Folder $folder): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, Folder $folder): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, Folder $folder): bool
    {
