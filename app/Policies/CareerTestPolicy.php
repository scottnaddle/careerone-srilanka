...
class CareerTestPolicy
{
    ...
    {
        return $adminUser->can('create_career::test');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, CareerTest $careerTest): bool
    {
        return $adminUser->can('update_career::test');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, CareerTest $careerTest): bool
    {
        return $adminUser->can('delete_career::test');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, CareerTest $careerTest): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, CareerTest $careerTest): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, CareerTest $careerTest): bool
    {
