        ...
        <div
            ...
            <div class="flex flex-col gap-6">
                <a href="{{ route('cgo.auth.login') }}"
                    ...
                    <span class="text-xl font-semibold text-gray-900 dark:text-white">{{trans('auth.cgo_sign_in')}}</span>
                </a>
                ...
                <form action="{{ route('cgo.auth.postForgotPassword') }}" class="leading-5" method="POST">
                    @csrf
                    <div class="mb-6">
                        <label for="email"
