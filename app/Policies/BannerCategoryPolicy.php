...
class BannerCategoryPolicy
{
    ...
    {
        return $adminUser->can('view_any_banner::category');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, BannerCategory $bannerCategory): bool
    {
        return $adminUser->can('view_banner::category');
    }
    ...
    {
        return $adminUser->can('create_banner::category');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, BannerCategory $bannerCategory): bool
    {
        return $adminUser->can('update_banner::category');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, BannerCategory $bannerCategory): bool
    {
        return $adminUser->can('delete_banner::category');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, BannerCategory $bannerCategory): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, BannerCategory $bannerCategory): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, BannerCategory $bannerCategory): bool
    {
