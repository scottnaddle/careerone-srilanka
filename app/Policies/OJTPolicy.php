...
class OJTPolicy
{
    ...
    {
        return $adminUser->can('view_any_o::j::t');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, OJT $oJT): bool
    {
        return $adminUser->can('view_o::j::t');
    }
    ...
    {
        return $adminUser->can('create_o::j::t');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, OJT $oJT): bool
    {
        return $adminUser->can('update_o::j::t');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, OJT $oJT): bool
    {
        return $adminUser->can('delete_o::j::t');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, OJT $oJT): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, OJT $oJT): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, OJT $oJT): bool
    {
