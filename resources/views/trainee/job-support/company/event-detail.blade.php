...
@section('content')
    <div class="py-6">
        <x-breadcrumb :items="[
            ...
            ['label' => 'Company list', 'url' => route('trainee.job-support.company.company-list')],
            [
            ...
            [
                'label' => 'Event list',
                'url' => route('trainee.job-support.company.event-list', [
                    'id' => $company->id,
                    'slug' => $company->slug,
                ]),
            ],
            ['label' => 'Event detail', 'url' => route('trainee.job-support.company.company-list')],
        ]" />
    </div>
        ...
        <div class="border rounded-lg px-3 py-4 flex flex-col gap-4 break-all">
            ...
            <div>
                <figure class="max-w-lg">
                    <img class="h-auto max-w-full rounded-lg click-zoom" src="{{ $event->thumbnail }}" alt="image description">
                </figure>
