<div>
    ...
    <div class="flex flex-col gap-2 bg-white dark:bg-[#1E1E1E] rounded-xl p-4 mb-10">
        ...
        <div class="flex flex-col gap-6">
            ...
            <form
                class="relative bg-white rounded-lg shadow-custom-light dark:shadow-custom-dark dark:bg-[#1E1E1E] w-full"
                method="POST" enctype="multipart/form-data" id="form-create"
                action="{{ route('admin.qnas.update', ['qNA' => $qna]) }}">
                @csrf
                @method('PUT')
                <p class="text-lg md:text-xl font-semibold px-4 md:px-5 dark:text-white">
                    {{ trans('system.form.edit_qna') }}</p>
                <div class="p-4 md:p-5 space-y-4">
                    <div class="flex flex-col">
                        <label for="title" class="text-sm font-medium text-gray-600 block dark:text-gray-300 mb-2">
                            {{ trans('system.information.qna.title') }}<span
                    ...
                    <div class="flex flex-col">
                        <label for="description"
                            ...
                            {{ trans('system.information.qna.content') }}<span
                                class="text-red-600 p-1 text-center">*</span></label>
                        ...
                        <div class="relative">
                            <div class="px-4 py-2 w-full sm:gap-4 sm:px-0 w-full" id="attachment-block">
                                <div class="mt-2 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                    <ul role="list"
                                        class="divide-y divide-gray-100 border rounded-md border-gray-300">
                                            ...
                                            <li class="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6"
                                                ...
                                                <div class="ml-4 flex-shrink-0">
                                                    <button type="button" data-id="{{ $item->id }}"
                                                        data-qna-id={{ $qna->id }} class="btn-delete">
                            ...
                            <div id="loading"
                                class="flex items-center justify-center w-full h-full border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700 top-0 absolute hidden">
                                <div role="status">
                        ...
                        <div x-data="dataFileDnD()"
                            ...
                            <div x-ref="dnd" class="relative flex flex-col text-gray-400 rounded cursor-pointer">
                                ...
                                <div class="flex flex-col items-center justify-center py-10 text-center">
                                    ...
                                    <p class="mb-2 text-base text-[#464559] dark:text-white">{!! trans('system.information.event.form.choose_file') !!}
                                    </p>
                                </div>
                            </div>
                ...
                <div
                    ...
                    <a href="{{ route('filament.admin.resources.information.q-as.view', ['record' => $qna]) }}"
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex justify-center gap-4">
                            <button type="button"
                                ...
                                <svg aria-hidden="true" id="loading-icon"
                                    class="hidden w-5 h-5 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600 mr-2"
                                    viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z"
                                        fill="currentColor" />
                            ...
                            <button data-modal-hide="modal-delete-attachment" type="button"
                                id="button-close-delete-modal"
                                class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                {{ trans('system.delete_modal.no') }}</button>
                        </div>
...
<script>
    $(".btn-delete").click(function() {
        ...
        const url = `${baseUrl}/admin/qnas/attachment/delete/${id}/${qna_id}`;
        // let url = 'admin/qnas/attachment/delete/' + id + '/' + qna_id;
