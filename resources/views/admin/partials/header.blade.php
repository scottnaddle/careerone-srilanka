<div class="flex flex-col gap-6 ">
    <nav class="bg-white border-gray-200 dark:bg-gray-900 md:mt-[54px]  rounded-xl">
        <div class=" flex flex-wrap items-center justify-between mx-auto p-4 md:gap-16 sm:gap-2">
            <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="/images/TVET.svg" alt="TVET Logo" />
            </a>

            <div class="flex items-center justify-center gap-2 md:order-last">
                <div class="flex">
                    ...
                    <!-- Dropdown menu -->
                    <div id="dropdownNotification" class="z-20 hidden w-full max-w-sm bg-white divide-y divide-gray-100 rounded-xl shadow dark:bg-gray-800 dark:divide-gray-700" aria-labelledby="dropdownNotificationButton">
                        ...
                        <div class="divide-y divide-gray-100 dark:divide-gray-700">
                            <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                                <div class="flex-shrink-0">
                                    ...
                                    <div class="absolute flex items-center justify-center w-5 h-5 ms-6 -mt-5 bg-blue-500 border border-white rounded-full dark:border-gray-800">
                                ...
                                <div class="w-full ps-3">
                                    ...
                                    <div class="text-xs text-primary dark:text-primary">a few moments ago</div>
                                </div>
                            </a>
                            <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                                <div class="flex-shrink-0">
                                ...
                                <div class="w-full ps-3">
                                    ...
                                    <div class="text-xs text-primary dark:text-primary">10 minutes ago</div>
                                </div>
                            </a>
                            <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                                <div class="flex-shrink-0">
                                ...
                                <div class="w-full ps-3">
                                    ...
                                    <div class="text-xs text-primary dark:text-primary">44 minutes ago</div>
                                </div>
                            </a>
                            <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                                <div class="flex-shrink-0">
                                ...
                                <div class="w-full ps-3">
                                    <div class="text-gray-500 text-sm mb-1.5 dark:text-gray-400"><span class="font-semibold text-gray-900 dark:text-white">Leslie Livingston</span> mentioned you in a comment: <span class="font-medium text-primary" href="#">@bonnie.green</span> what do you say?</div>
                                    <div class="text-xs text-primary dark:text-primary">1 hour ago</div>
                                </div>
                            </a>
                            <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                                <div class="flex-shrink-0">
                                ...
                                <div class="w-full ps-3">
                                    ...
                                    <div class="text-xs text-primary dark:text-primary">3 hours ago</div>
                                </div>
                            </a>
                        </div>
                ...
                <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    ...
                    <!-- Dropdown menu -->
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-xl shadow dark:bg-[#1E1E1E] dark:divide-gray-600" id="user-dropdown">
                        <div class="px-4 py-3">
                    ...
                    <button data-collapse-toggle="navbar-user" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-xl md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-user" aria-expanded="false">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1  md:grow" id="navbar-user">
                <form class="w-full">
                    ...
                    <div class="relative">
                        ...
                        {{--                        </svg>--}}
                        {{--                    </div>--}}
                        <input type="search" id="default-search" class="block w-full p-4 ps-10 text-sm border-none text-gray-900 rounded-xl bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-[#1E1E1E] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." required />
                        <button type="submit" class="text-[#C9CCD4] absolute end-3 bottom-3  font-medium rounded-xl text-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
