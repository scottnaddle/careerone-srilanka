...
class InstitutePolicy
{
    ...
    {
        return $adminUser->can('view_any_api::institute');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, Institute $institute): bool
    {
        return $adminUser->can('view_api::institute');
    }
    ...
    {
        return $adminUser->can('create_api::institute');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, Institute $institute): bool
    {
        return $adminUser->can('update_api::institute');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, Institute $institute): bool
    {
        return $adminUser->can('delete_api::institute');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, Institute $institute): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, Institute $institute): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, Institute $institute): bool
    {
