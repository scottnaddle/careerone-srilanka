...
@section('content')
    <div class="max-w-2xl mx-auto w-screen py-24 flex flex-col h-full justify-start">
        <div
            class="bg-white shadow-md  space-y-6 border-gray-200 rounded-xl px-10 py-5 dark:bg-[#1E1E1E]">
            <div class="flex flex-col gap-6">
                ...
                @endif
                <form class="leading-5" action="{{ route('cgo.auth.postLogin') }}" method="POST" autocomplete="off">
                    @csrf
                    <div class="mb-6">
                        <label for="email"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="relative">
                            <input type="password" name="password" id="password"
                                   class="bg-gray-50 border border-gray-300 py-2 px-4 text-gray-900 sm:text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-1 dark:bg-[#1E1E1E] dark:border-white dark:placeholder-white dark:text-white">
