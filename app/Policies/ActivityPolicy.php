...
class ActivityPolicy
{
    ...
    {
        return $adminUser->can('view_any_activity');
    }
    ...
    {
        return $adminUser->can('view_activity');
    }
    ...
    {
        return $adminUser->can('create_activity');
    }
    ...
    {
        return $adminUser->can('update_activity');
    }
    ...
    {
        return $adminUser->can('delete_activity');
    }
