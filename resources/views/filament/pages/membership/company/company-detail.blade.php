                ...
                <div class="col-span-1 max-w-xs">
                    <div class="flex flex-col">
                        <div class="flex items-center">
                            ...
                            @if ($traineeData->isFullyVerified())
                                ...
                                @elseif($traineeData->isPendingVerified())
                                    <span style="font-size:12px; color: gray; padding: 0.2rem 0.4rem; border-radius: 0.25rem; font-weight:600; display: inline-flex; align-items: center;">
                        ...
                        @if($traineeData->reason != null)
                            <span class="dark:text-white flex gap-1 items-center">Reason: {{$traineeData->reason}}</span>
                        @endif
                    </div>
                </div>
            </div>
