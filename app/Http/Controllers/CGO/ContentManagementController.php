...
class ContentManagementController extends Controller
{
    ...
    public function getVideos(Request $request) {
        ...
        return view('cgo.informations.content-management.videos', compact('videos', 'status', 'keyword','count','order'));
    }
...
//            return response()->json(['error' => $validator->errors()], 404);
        ...
        if ($request->action == 'add') {
            ...
            if (!$video) {
                return redirect()->route('cgo.informations.content-management.videos')->withErrors('Can not find this content or you do not have permission!');
            }
        }
    ...
    public function deleteVideo($slug) {
        ...
        if ($video) {
            ...
            return redirect()->route('cgo.informations.content-management.videos')->withErrors('We can not delete this content or you do not have permission!');
        }
    }
    public function deleteDocument($id) {
        ...
        if ($video) {
            ...
            return redirect()->route('cgo.informations.content-management.documents')->withErrors('We can not delete this content or you do not have permission!');
        }
    }
    public function getDocuments(Request $request) {
        ...
        return view('cgo.informations.content-management.documents', compact('documents', 'status', 'keyword','count','order'));
    }
    ...
    public function postDocument(Request $request) {
        ...
        if ($request->action == 'add') {
            ...
            if (!$document) {
                return redirect()->route('cgo.informations.content-management.documents')->withErrors('Can not find this content or you do not have permission!');
            }
        }
    ...
    public function downloadDocument($id) {
        ...
        return redirect()->route('cgo.informations.content-management.documents')->withErrors('Can not find this content!');
    }
}
