...
@push('js')
    ...
    <script>
        // Password validation rules and helper functions (Global Scope)
        ...
        // Global function to manage tab switching and update the Stepper
        let currentTab = 0;
        ...
        function showTab(n) {
            ...
            // When moving to the confirmation tab (final tab)
            if (n === 2) {
        ...
        function validateFormTab(tabIndex) {
            ...
            // Require the Company ID to be checked at the first step
            if (tabIndex === 0) {
            ...
            // Validate the password at step 2
            if (tabIndex === 1) {
    ...
    <script type="module">
        $(document).ready(function() {
            ...
            // Logic to manage the state of the final Sign Up button
            ...
            // Sync input data between the main search field and the Modal input field
...
`);
        ...
        // Handle the event when a company is selected from the Modal
        ...
        // Confirm password match with visual feedback
