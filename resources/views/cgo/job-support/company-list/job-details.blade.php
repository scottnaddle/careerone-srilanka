...
@section('content')
    <div class="my-6 flex flex-col gap-5">
        <p class="text-2xl text-[#464559] dark:text-white font-semibold">{{ trans('cgo.job_support.company_list.root') }}</p>
        <div class="py-6">
            <x-breadcrumb :items="[
                ...
                ['label' =>  \Str::limit($jobDetail->company->name,15), 'url' => route('cgo.job-support.company-list.job-list', ['company'=>$jobDetail->company_id])],
