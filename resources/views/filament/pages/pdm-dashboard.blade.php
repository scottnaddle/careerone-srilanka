...
<div class="space-y-6" x-data="{}">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-4">
        ...
        @foreach($allStats as $stat)
            <a href="{{ $stat['link'] }}" class="group relative bg-white dark:bg-gray-800 rounded-2xl p-5 border border-gray-100 dark:border-gray-700 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 block no-underline">
    ...
    {{-- OJT + Job — clickable detail cards --}}
