    ...
    public static function table(Table $table): Table
    {
        ...
        return $table
            ->modifyQueryUsing(function (Builder $query) {
                ...
                // If not super_admin, only show events created by CGOs belonging to the user's institutes
                if (!$isSuperAdmin) {
                    $userTvetType = $user->tvet_type;
                ...
                // Sort: main events first, then by created_at
