...
<html lang="en" xmlns:mso="urn:schemas-microsoft-com:office:office" xmlns:msdt="uuid:C2F41010-65B3-11d1-A29F-00AA00C14882">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('career-test-libs/style.css')}}">
        ...
        <script>
            ...
            let page = 1
            if (localStorage.getItem('ckt-page')) {
                page = localStorage.getItem('ckt-page')
            }

            let progress = 0;
            if (localStorage.getItem('ckt-progress')) {
                progress = localStorage.getItem('ckt-progress')
            }
            ...
            if (localStorage.getItem('ckt-results')) {
                results = JSON.parse(localStorage.getItem('ckt-results'))
            }

            let completedQuestions = {}
            if (localStorage.getItem('ckt-completedQuestions')) {
                completedQuestions = JSON.parse(localStorage.getItem('ckt-completedQuestions'))
            }
            ...
            let translations = {
                en: {
                    ...
                    pageOnePara3: 'To start the test, please fill the name below and click on the start button.',
                ...
                sn: {
                    ...
                    pageOnePara3: 'ආරම්භ කිරීම සඳහා පහත කොටුවෙහි ඔබගේ නම සඳහන් කර ආරම්භක බොත්තම ක්ලික් කරන්න',
                ...
                tm: {
                    ...
                    pageOnePara1: 'தங்களுக்கு பொருத்தமான தொழில் துறைகளை இனங்காண்பதற்காக கீழ் குறிப்பிடப்படும் பரிசோதனையில் பங்குபற்றவும்.',
                    pageOneBox1Title: 'தாங்கள்',
                    pageOneBox1Description: 'தங்களது தேவை பெறுமதிகள் திறமைகள் இயலுமைகள் சுவை மற்றும் எதிர்பார்ப்புக்கள்',
                    ...
                    pageOnePara2: 'தங்களது விருப்பத்தினை அளவீடு செய்து தங்களுக்கு பொருத்தமான தொழில்துறைகளைத் தேர்ந்தெடுக்கவும். தங்களுக்குரிய தொழிலைத் தேர்ந்தெடுப்பதற்கு மேற்கொள்ளும் ஒப்பீட்டு செயற்பாடு ஆகும்',
                    pageOnePara3: 'இது தங்களை மிகவும் திருப்திப்படுத்தும் தொழில் வாய்ப்பினை எவ்வாறு இனம்காண முடியும் என்பதை சுட்டிக் காட்டுகிறது. ஆரம்பிப்பதற்காக அடுத்த பக்கத்தை பார்க்கவும்.',
                    pageOneButton: 'சோதனையைத் தொடங்குங்கள்',
                    pageOneError: 'உங்கள் பெயரைச் சேர்க்கவும்!',
                    pageOneCopyRight: 'Lawrence K’Jones, Ph.D, NCC இன் The Career Key ஊடாக கொழும்பு பல்கலைக்கழகத்தின் தொழில் வழிகாட்டல் ஆலோசனைப் பிரிவின். விரிவுரையாளர் கீர்த்தி பிரேமதாஸ மற்றும் அஜித் ஜயவர்த்தன ஆகியோரின் ஆக்கமாகும்',
            ...
            function changePage(page) {
                ...
                localStorage.setItem('ckt-page', page)
                $('#page1').fadeOut()
                $('#page2').fadeOut()
                $('#page3').fadeOut()
                $('#page4').fadeOut()
                ...
                if (page === 1) {
                    localStorage.removeItem('ckt-progress')
                    localStorage.removeItem('ckt-results')
                    localStorage.removeItem('ckt-completedQuestions')
                    localStorage.removeItem('ckt-personName')
                    location.reload()
                }

                if (page == 4) {
                    if (localStorage.getItem('ckt-progress') === '0') {
                    ...
                    if (localStorage.getItem("ckt-results") !== null) {
                        let csrf = $('meta[name="csrf_token"]').attr('content');
                        $.ajax({
                            url : "{{ route('testnow.save-results') }}",
                            data : {
                                '_token': csrf,
                                'name' : localStorage.getItem("ckt-personName"),
                                'results' : localStorage.getItem("ckt-results")
                            },
                            type : 'POST',
                            dataType : 'json',
            ...
            function setProgress(progress) {
                localStorage.setItem('ckt-progress', progress)
            ...
            function updateResults(type, question) {
                ...
                localStorage.setItem('ckt-completedQuestions', JSON.stringify(completedQuestions))
            ...
            <div class="container">
                ...
                <div id="page1" class="row">
                    <div class="col-lg-8 text-center content-box">
                        ...
                        <p id="pageOnePara3">To start the test, please fill the name below and click on the start button.</p>
                ...
                <div id="page4" class="row">
                    <div class="col-lg-10 text-center content-box">
                        ...
                        <h5 class="text-start ps-md-4 mt-4" id="pageFourNotesTitle">Career Counselling Notes</h5>
