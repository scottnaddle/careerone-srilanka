...
class BannerPolicy
{
    ...
    {
        return $adminUser->can('view_any_banner');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, Banner $banner): bool
    {
        return $adminUser->can('view_banner');
    }
    ...
    {
        return $adminUser->can('create_banner');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, Banner $banner): bool
    {
        return $adminUser->can('update_banner');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, Banner $banner): bool
    {
        return $adminUser->can('delete_banner');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, Banner $banner): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, Banner $banner): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, Banner $banner): bool
    {
