    ...
    <div class="flex flex-col gap-2.5 w-full max-w-xl bg-white px-4 md:px-8 py-6 rounded-xl dark:bg-[#1E1E1E]">
        ...
        <div class="flex flex-col gap-6">
            ...
            <div class="flex flex-col gap-6 mt-4">
                <!-- Left column: Icon and greeting similar to CGO but with the identifier text changed to Company -->
                <div class="flex flex-col items-center justify-center gap-4">
                    <img src="/images/companny-user-icon.webp" class="w-1/2 lg:w-1/3" alt="Company portal icon">
...
@push('js')
    ...
    <script>
        $(document).ready(function() {
            // Script for synchronized password Show / Hide
