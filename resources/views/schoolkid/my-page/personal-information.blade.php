                ...
                <form class="flex flex-col gap-6 px-6 py-5 lg:justify-between" method="post" action="{{route('trainee.my-page.personal-information.post')}}" enctype="multipart/form-data">
                    ...
                    <div class="w-full">
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            <div class="">
                                <label for="first_name" class="block mb-2 text-sm font-medium text-[#706F81] dark:text-white">{{trans('cgo.first_name')}} <span class="text-red-700">*</span></label>
                                <input type="text" id="full_name" class="opacity-70 border border-[#EDEDED] text-[#464559] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#1E1E1E] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 cursor-not-allowed" value="{{$user->first_name}}" name="first_name" required readonly />
                            </div>
                            <div class="">
                                <label for="last_name" class="block mb-2 text-sm font-medium text-[#706F81] dark:text-white">{{trans('cgo.last_name')}} <span class="text-red-700">*</span></label>
                                <input type="text" id="last_name" class="opacity-70 border border-[#EDEDED] text-[#464559] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#1E1E1E] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 cursor-not-allowed" value="{{$user->last_name}}" name="last_name" required readonly />
                            </div>
                            <div class="">
                            ...
                            <div class="">
                                <label for="contact_address" class="block mb-2 text-sm font-medium text-[#706F81] dark:text-white">{{ trans('system.form.contact_address') }} <span class="text-red-700">*</span></label>
                                <input type="text" id="contact_address" class="border border-[#EDEDED] text-[#464559] text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#1E1E1E] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{$user->contact_address}}" name="contact_address" required />
                            </div>
