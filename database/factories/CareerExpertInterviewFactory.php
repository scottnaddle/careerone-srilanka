...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\CareerExpertInterview>
 */
class CareerExpertInterviewFactory extends Factory
{
    /**
    ...
    {
        $imageUrl = 'https://picsum.photos/seed/' . $this->faker->unique()->word . '/300/200';
        ...
        return [
            'title' => $this->faker->name,
            'thumbnail' => 'storage/cgo/career_expert_interview/thumbnails/' . $imageName,
            'slug' => $slug,
