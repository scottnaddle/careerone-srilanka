    ...
    <div class="mb-6 flex flex-col">
        ...
        <div class="py-6">
            <x-breadcrumb :items="[
                ...
                ['label' => trans('cgo.job_applied'), 'url' => ''],
            ]" />
        </div>
                                ...
                                <div class="flex gap-6 items-center">
                                    ...
                                    <div class="flex flex-col gap-1 items-start">
                                        <p class="flex gap-3 items-center">
                                            <a href="{{ route('cgo.job-support.job-list.trainee-applied-information', ['slug' => $job->slug, 'trainee' => $trainee]) }}"
                                            ...
                                            <span class="text-sm px-2.5 py-1 rounded shadow-xs text-white bg-primary">
                                                        {{ \App\Enums\TypeTraineeApply::getNameByKey('apply') }}
                                                    </span>
                                        ...
                                        <p class="text-sm text-[#706F81] dark:text-white">
                                            ...
                                            {{ trans('company.applied_at') }} {{ date('Y-m-d', strtotime(getTimeApply($trainee->id, $job->id, 'job', 'apply'))) }}
                                        </p>
                                    </div>
                                </div>
                            </td>
