...
class EventPolicy
{
    ...
    {
        return $adminUser->can('view_any_information::event::list::rejected');
    }
    ...
    {
        return $adminUser->can('view_information::event::list::rejected');
    }
    ...
    {
        return $adminUser->can('create_information::event::list::rejected');
    }
    ...
    {
        return $adminUser->can('update_information::event::list::rejected');
    }
    ...
    {
        return $adminUser->can('delete_information::event::list::rejected');
    }
