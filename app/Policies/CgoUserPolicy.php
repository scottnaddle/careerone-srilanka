...
class CgoUserPolicy
{
    ...
    {
        return $adminUser->can('view_any_cgo::reject::list');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, CgoUser $cgoUser): bool
    {
        return $adminUser->can('view_cgo::reject::list');
    }
    ...
    {
        return $adminUser->can('create_cgo::reject::list');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, CgoUser $cgoUser): bool
    {
        return $adminUser->can('update_cgo::reject::list');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, CgoUser $cgoUser): bool
    {
        return $adminUser->can('delete_cgo::reject::list');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, CgoUser $cgoUser): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, CgoUser $cgoUser): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, CgoUser $cgoUser): bool
    {
