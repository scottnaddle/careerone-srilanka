...
class RolePolicy
{
    ...
    {
        return $adminUser->can('view_any_shield::role');
    }
    ...
    {
        return $adminUser->can('view_shield::role');
    }
    ...
    {
        return $adminUser->can('create_shield::role');
    }
    ...
    {
        return $adminUser->can('update_shield::role');
    }
    ...
    {
        return $adminUser->can('delete_shield::role');
    }
    ...
    {
        return $adminUser->can('delete_any_shield::role');
    }
