...
class NVQLevelPolicy
{
    ...
    {
        return $adminUser->can('view_any_api::packages');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, NVQLevel $nVQLevel): bool
    {
        return $adminUser->can('view_api::packages');
    }
    ...
    {
        return $adminUser->can('create_api::packages');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, NVQLevel $nVQLevel): bool
    {
        return $adminUser->can('update_api::packages');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, NVQLevel $nVQLevel): bool
    {
        return $adminUser->can('delete_api::packages');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, NVQLevel $nVQLevel): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, NVQLevel $nVQLevel): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, NVQLevel $nVQLevel): bool
    {
