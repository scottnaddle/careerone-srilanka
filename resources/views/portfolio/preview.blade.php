...
<div class="h-12 bg-primary sticky top-0 w-full flex items-center z-10 px-4 rounded-t no-print">
    <div class="mx-auto max-w-[1440px] flex justify-end w-full">
        <div class="flex justify-end gap-4 items-center">
            <a href="{{route('trainee.career-guidance.portfolio.export-portfolio',['pid' => $portfolio->id, 'lang' => app()->getLocale() ?? 'en'])}}" target="_blank" class="text-white text-xl flex items-center gap-1 hover:underline"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
...
<div class="max-w-[1440px] xl:px-[54px] mx-auto no-break">
                ...
                <div class="p-4 flex flex-col gap-6">
                    ...
                    <div class="bg-white dark:bg-[#1E1E1E] flex w-full items-center p-5 rounded-xl shadow-custom-light dark:shadow-custom-dark border border-gray-300 dark:border-white">
                        <div class="flex flex-col gap-4">
                            ...
                            <p class="text-lg text-[#706F81] dark:text-white whitespace-pre-line break-words" style="word-break: break-word;" id="trainee-basic-information">{{$portfolioDatas['about_me']}}</p>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 tvec-information">
                        <div class="bg-white dark:bg-[#1E1E1E] flex w-full items-center p-5 rounded-xl shadow-custom-light dark:shadow-custom-dark border border-gray-300 dark:border-white">
                    ...
                    <div class="example-information bg-white dark:bg-[#1E1E1E] flex w-full items-center p-5 rounded-xl shadow-custom-light dark:shadow-custom-dark border border-gray-300 dark:border-white overflow-hidden break-words">
                        <div class="flex flex-col gap-4 w-full h-full">
                            ...
                            <ol class="relative border-s border-primary">
                                @forelse($portfolioDatas['educations'] as $education)
                                    <li class="mb-10 ms-4">
                                        <div class="absolute mt-1.5 -start-1.5 ">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
                                                <circle cx="5" cy="5" r="5" fill="#4984F6" />
                                            </svg>
                                        </div>
                    ...
                    <div class="example-information bg-white dark:bg-[#1E1E1E] flex w-full items-center p-5 rounded-xl shadow-custom-light dark:shadow-custom-dark border border-gray-300 dark:border-white overflow-hidden break-words" style="word-break: break-word">
                        <div class="flex flex-col gap-4">
                                ...
                                <ol class="relative border-s border-primary">
                                    @forelse($portfolioDatas['experiences'] as $experience)
                                        <li class="mb-10 ms-4">
                                            ...
                                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white break-words">{{ $experience['job_title'] }}</h3>
                                            <p class="text-md font-medium text-gray-700 dark:text-gray-300">{{ $experience['company'] }} <span >• {{ $experience['district'] }}</span></p>
                                    ...
                                    <div class="flex flex-col gap-4">
                                        @forelse($portfolioDatas['skills'] as $skill)
                                            <div class="flex gap-4 items-baseline">
                                                ...
                                                <div class="flex flex-col gap-2">
                                                    <p>
                                                        <span class="text-[#464559] text-xl font-semibold dark:text-white break-words">{{$skill['name']}}</span>
                                                    </p>
                                                    <p>
                                                        <span class="text-[#91919A] dark:text-white whitespace-pre-line break-words">{{$skill['description']}}</span>
                                                    </p>
                                                </div>
                                            </div>
                                        @empty
