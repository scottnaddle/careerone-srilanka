...
class FaqController extends Controller
{
    ...
    public function cgoShow($id)
    {
        ...
        return view('informations.notice.faq-show', compact('faq'));
    }

    public function getFaqArticleById($id) {
        $article = FaqArticle::where('id', $id)->first();
        if ($article) {
            return view('informations.notice.faq-show-article', compact('article'));
        }
    }
}
