...
@section('content')
    <div class="my-6 flex flex-col gap-5">
        <p class="text-2xl text-[#464559] dark:text-white  dark:text-white font-semibold">Job/Career information</p>
        <div class="bg-white dark:bg-[#1E1E1E] rounded-xl px-4 py-5 flex flex-col gap-5">
            <div class="flex flex-col gap-6">
                <a class="text-xl text-[#464559] dark:text-white w-fit flex gap-4 items-center font-semibold" href="{{route('trainee.career-guidance.job-career-information.job-information')}}">
                ...
                <div class="flex flex-col gap-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="flex flex-col gap-2">
                            <p class="font-semibold text-[#201F36]">Sub job catagory</p>
