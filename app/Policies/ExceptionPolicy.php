...
class ExceptionPolicy
{
    ...
    {
        return $adminUser->can('view_any_exception');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, Exception $exception): bool
    {
        return $adminUser->can('view_exception');
    }
    ...
    {
        return $adminUser->can('create_exception');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, Exception $exception): bool
    {
        return $adminUser->can('update_exception');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, Exception $exception): bool
    {
        return $adminUser->can('delete_exception');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, Exception $exception): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, Exception $exception): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, Exception $exception): bool
    {
