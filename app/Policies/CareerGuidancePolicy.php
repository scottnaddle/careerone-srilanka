...
class CareerGuidancePolicy
{
    ...
    {
        return $adminUser->can('view_any_career::guide');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, CareerGuidance $careerGuidance): bool
    {
        return $adminUser->can('view_career::guide');
    }
    ...
    {
        return $adminUser->can('create_career::guide');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, CareerGuidance $careerGuidance): bool
    {
        return $adminUser->can('update_career::guide');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, CareerGuidance $careerGuidance): bool
    {
        return $adminUser->can('delete_career::guide');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, CareerGuidance $careerGuidance): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, CareerGuidance $careerGuidance): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, CareerGuidance $careerGuidance): bool
    {
