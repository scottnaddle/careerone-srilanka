                ...
                <div class="px-4 py-4 flex flex-col gap-6">
                    <div class="bg-white dark:bg-[#1E1E1E] flex w-full items-center  justify-center rounded-xl shadow-custom-light dark:shadow-custom-dark border border-gray-300 dark:border-white">
                        <div class="w-full bg-white dark:bg-[#1E1E1E] transform duration-200 easy-in-out rounded-xl">
                            <div class=" h-64 overflow-hidden">
                                <img class="w-full rounded-t-xl" src="https://images.unsplash.com/photo-1605379399642-870262d3d051?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=2000&q=80" alt="background cover" />
                            </div>
                            <div class="flex justify-start px-5  -mt-12" id="trainee_avatar">
                                <img class="h-32 w-32 bg-white p-1 rounded-full  " src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=2000&q=80" alt="avatar" />
                            </div>
                    ...
                    <div class="bg-white dark:bg-[#1E1E1E] flex w-full items-center p-5 rounded-xl shadow-custom-light dark:shadow-custom-dark border border-gray-300 dark:border-white">
                        <div class="flex flex-col gap-4">
                            <p class="text-2xl text-[#4984F6] dark:text-white font-semibold" data-gjs-editable="false" data-gjs-removable="false">Basic Information</p>
                    ...
                    <div class="bg-white dark:bg-[#1E1E1E] flex w-full items-center p-5 rounded-xl shadow-custom-light dark:shadow-custom-dark border border-gray-300 dark:border-white">
                        <div class="flex flex-col gap-4">
                            ...
                            <p class="text-lg text-[#706F81] dark:text-white" id="trainee-basic-information">{{$portfolioDatas['about_me']}}</p>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 tvec-information">
                        <div class="bg-white dark:bg-[#1E1E1E] flex w-full items-center p-5 rounded-xl shadow-custom-light dark:shadow-custom-dark border border-gray-300 dark:border-white">
                            <div class="flex flex-col gap-4 w-full h-full">
                                <p class="text-2xl text-[#4984F6] dark:text-white font-semibold">TVEC Education</p>
                                    ...
                                    <div class="flex gap-4 items-baseline">
                                        ...
                                        <div class="flex flex-col gap-2 dark:text-white">
                                            <p class="">
                                                ...
                                                <span class="text-[#706F81]  dark:text-white"> (Industry sector: {{$tvecCourse['industry_sector']}})</span>
                                            </p>
                                            <p class="dark:text-white"><span class="font-semibold">Course name: {{$tvecCourse['course_name']}}</span> <span class="text-sm">({{$tvecCourse['from']}} - {{$tvecCourse['to']}})</span></p>
                        ...
                        <div class="bg-white dark:bg-[#1E1E1E] flex w-full items-center p-5 rounded-xl shadow-custom-light dark:shadow-custom-dark border border-gray-300 dark:border-white">
                            <div class="flex flex-col gap-4 w-full h-full">
                                <p class="text-2xl text-[#4984F6] dark:text-white font-semibold" id="nvq_type">NVQ Qualification</p>
                                <div class="flex flex-col gap-4 w-full h-full" id="qualification_block">
                                    ...
                                    <div class="flex gap-4 items-baseline">
                                        ...
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <p>
                                                <span class="text-[#91919A] dark:text-white">{{$nvq['effective_date']}}</span>
                                            </p>
                                        </div>
                                    </div>
                                    @empty
                    ...
                    <div class="example-information bg-white dark:bg-[#1E1E1E] flex w-full items-center p-5 rounded-xl shadow-custom-light dark:shadow-custom-dark border border-gray-300 dark:border-white">
                        <div class="flex flex-col gap-4 w-full h-full">
                            ...
                            <div class="flex  flex-col gap-4 w-full h-full" id="">
                                ...
                                <div class="flex gap-4 items-baseline">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        <p>
                                            ...
                                            <span class="text-[#706F81]  dark:text-white"> ({{$education['district']}} - {{$education['province']}})</span>
                                        </p>
                                        <p>
                                            <span class="text-[#91919A] dark:text-white">{{$education['from']}} - {{$education['to']}}</span>
                                        </p>
                                    </div>
                                </div>
                                @empty
                    ...
                    <div class="example-information bg-white dark:bg-[#1E1E1E] flex w-full items-center p-5 rounded-xl shadow-custom-light dark:shadow-custom-dark border border-gray-300 dark:border-white">
                        <div class="flex flex-col gap-4">
                            <p class="text-2xl text-[#4984F6] dark:text-white font-semibold">OJT Experience</p>
                            <div id="ojt-experience">
                                <ol class="relative border-s border-gray-200 dark:border-white">
                                    ...
                                    <li class="mb-10 ms-4">
                                        ...
                                        <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-white">{{$ojt['time']}}</time>
                                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{$ojt['ojt_name']}}</h3>
                                        <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">{{$ojt['ojt_description']}}</p>
                                    </li>
                                    @empty
                                    @endforelse
                                </ol>
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <div id="experience">
                                <ol class="relative border-s border-gray-200 dark:border-white">
                                    ...
                                    <li class="mb-10 ms-4">
                                        <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-white"></div>
                                        <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-white">{{$experience['time']}}</time>
                                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{$experience['experience_name']}}</h3>
                                        <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">{{$experience['experience_description']}}</p>
                                    </li>
                                    @empty
                                    @endforelse
                                </ol>
                    ...
                    <div class="grid grid-cols-1 gap-6 " id="evidence">
                        <div class="bg-white dark:bg-[#1E1E1E] flex flex-col gap-4 w-full shadow-custom-light dark:shadow-custom-dark p-5 rounded-xl border border-gray-300 dark:border-white">
                            <p class="text-2xl text-[#4984F6] dark:text-white font-semibold">Evidence</p>
                            <div class="flex flex-col gap-5" id="evidence_block">
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                                    @forelse($portfolioDatas['evidences'] as $evidence)
                                    <div class="mb-10 px-4 border border-gray-300 dark:border-white rounded-xl example-information">
                                        <div class=" h-96 overflow-hidden flex justify-center border-b border-gray-300 dark:border-white">
                                            <img src="/images/certificate-sample.webp" class="object-cover object-center h-full w-auto !filter-none">
                                        </div>
                                        <h2 class="title-font text-2xl font-medium text-gray-900 mt-6 mb-3">{{$evidence['name']}}({{$evidence['time']}}) </h2>
                                        <p class="leading-relaxed text-base">{{$evidence['description']}}</p>
                                    </div>
                                    @empty
                                    @endforelse
