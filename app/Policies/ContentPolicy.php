...
class ContentPolicy
{
    ...
    {
        return $adminUser->can('view_any_information::content::content::list');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, Content $content): bool
    {
        return $adminUser->can('view_information::content::content::list');
    }
    ...
    {
        return $adminUser->can('create_information::content::content::list');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, Content $content): bool
    {
        return $adminUser->can('update_information::content::content::list');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, Content $content): bool
    {
        return $adminUser->can('delete_information::content::content::list');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, Content $content): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, Content $content): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, Content $content): bool
    {
