...
class CodeManagementPolicy
{
    ...
    {
        return $adminUser->can('view_any_code::management');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, CodeManagement $codeManagement): bool
    {
        return $adminUser->can('view_code::management');
    }
    ...
    {
        return $adminUser->can('create_code::management');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, CodeManagement $codeManagement): bool
    {
        return $adminUser->can('update_code::management');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, CodeManagement $codeManagement): bool
    {
        return $adminUser->can('delete_code::management');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, CodeManagement $codeManagement): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, CodeManagement $codeManagement): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, CodeManagement $codeManagement): bool
    {
