<div>
    ...
    <div class="w-full p-6 space-y-6 bg-white mt-4 rounded-xl flex flex-col">
        <x-breadcrumb :items="[
                ...
                ['label' => $company->name, 'url' => '/admin/company-jobs/'.$company->id.'/view'],
                ['label' => 'Candidate  list', 'url' => '#'],
            ]" />
{{--        <span class="text-lg font-semibold text-[#464559] dark:text-white">Candidate list</span>--}}
        <a href="{{ route('filament.admin.resources.company-jobs.view', ['record' => $company->id]) }}"
                    ...
                    <div class="flex gap-6 items-center w-full">
                        ...
                        <div class="flex flex-col gap-1 w-full">
                            <p class="flex gap-3 items-center w-full flex-wrap flex-row">
                                ...
                                @foreach (array_unique($apply->apply_types) as $apply_type)
                                    <span
                                        class="text-sm px-2.5 py-1 rounded shadow-xs text-white {{ $apply_type == 'apply' ? 'bg-[#1e429f]' : 'bg-[#4984F6]' }}">
                                        {{ \App\Enums\TypeTraineeApply::getNameByKey($apply_type) }}
                                    </span>
                                @endforeach

                            </p>
{{--                            <span class=" font-normal text-base h-6">--}}
{{--                                Lanka Hotel  | Web Designer ㅣ NVQ 5 ㅣ Tourism--}}
{{--                            </span>--}}
        ...
        <div id="default-modal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative w-full max-w-4xl max-h-full p-4" style="padding: 16px;">
                <div class="relative bg-white rounded-lg shadow dark:bg-[#1E1E1E] dark:border-white">
                    ...
                    <!-- Modal header -->
                    <div class="flex items-center justify-between p-4 md:p-5 rounded-t-lg bg-[#5736ec] dark:bg-[#383838] px-6 py-4"
                        style="background-color: #4984F6">
