    ...
    <div class="max-w-lg mx-auto w-screen py-24">
        <div
            ...
            <div class="flex flex-col gap-6">
                <a href="{{ route('schoolkid.auth.login') }}"
                    ...
                    <span class="text-xl font-semibold text-gray-900 dark:text-white">{{trans('auth.schoolkid_sign_in')}}</span>
                </a>
                ...
                <form action="{{ route('schoolkid.auth.postForgotPassword') }}" class="leading-5" method="POST">
                    @csrf
                    <div class="mb-6">
                        <label for="email"
