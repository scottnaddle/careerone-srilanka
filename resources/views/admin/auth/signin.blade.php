<div class="max-w-xl mx-auto px-4 md:px-8 bg-white dark:bg-[#1E1E1E] py-6 rounded-xl my-6">
        ...
        <div class="flex flex-col gap-6">
            ...
            <div class="flex flex-col gap-6 mt-4">
                ...
                <div class="flex flex-col items-center justify-center gap-4">
                    <img src="/images/admin.svg" alt="Admin portal icon">
    ...
    <!-- CSS configuration overriding Filament's default button -->
    <style>
        .fi-ac-btn-action {
            ...
            background-color: #4984F6 !important; /* System primary blue color */
