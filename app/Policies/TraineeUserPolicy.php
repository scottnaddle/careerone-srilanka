...
class TraineeUserPolicy
{
    ...
    {
        return $adminUser->can('view_any_trainee');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, TraineeUser $traineeUser): bool
    {
        return $adminUser->can('view_trainee');
    }
    ...
    {
        return $adminUser->can('create_trainee');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, TraineeUser $traineeUser): bool
    {
        return $adminUser->can('update_trainee');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, TraineeUser $traineeUser): bool
    {
        return $adminUser->can('delete_trainee');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, TraineeUser $traineeUser): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, TraineeUser $traineeUser): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, TraineeUser $traineeUser): bool
    {
