...
@section('title', 'CGO - Job support - OJT List - Trainee Information')
...
{{--        <p class="text-2xl text-[#464559] dark:text-white font-semibold">{{ trans('cgo.job_support.ojt_list.trainee_match.trainee_information.root') }}</p>--}}
        <div class="py-6">
            <x-breadcrumb :items="[
                ...
                ['label' => trans('cgo.job_support.ojt_list.trainee_match.root'), 'url' => route('cgo.job-support.ojt-list.trainee-match', ['slug' => $ojt->slug])],
                ['label' => trans('cgo.job_support.ojt_list.trainee_match.trainee_information.root'), 'url' => '#']
            ]" />
        </div>
        <form id="form-submit" action="{{ route('cgo.job-support.ojt-list.match-trainee') }}" method="POST" id="match">
            @csrf
...
{{--                            <div class="flex flex-col gap-4 w-full lg:w-1/2">--}}
{{--                                <p class="text-2xl text-[#4984F6] dark:text-white font-semibold">{{ trans('cgo.job_support.ojt_list.trainee_match.trainee_information.experience') }}</p>--}}
{{--                                @foreach (json_decode($trainee->traineeInformation->experience) as $experience)--}}
{{--                                    <div class="flex  flex-col gap-4">--}}
{{--                                        <div class="flex gap-4 items-baseline">--}}
{{--                                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10"--}}
{{--                                                viewBox="0 0 10 10" fill="none">--}}
...
{{--                                                <p>--}}
{{--                                                    <span--}}
{{--                                                        class="text-[#464559] text-xl font-semibold dark:text-white">{{ $experience->name }}</span>--}}
{{--                                                </p>--}}
{{--                                                <p>--}}
{{--                                                    <span--}}
{{--                                                        class="text-[#706F81] dark:text-white">{{ $experience->description }}</span>--}}
{{--                                                </p>--}}
{{--                                                <p>--}}
{{--                                                    <span--}}
{{--                                                        class="text-[#91919A] text-sm dark:text-white">{{ $experience->start_year }}--}}
...
{{--                        <div class="flex gap-6 flex-col">--}}
{{--                            <div class="flex flex-col gap-4 w-full lg:w-1/2">--}}
{{--                                <p class="text-2xl text-[#4984F6] dark:text-white font-semibold">{{ trans('company.job_support.trainee_list.modal_content.attachment') }}</p>--}}
{{--                                <div class="flex  flex-wrap gap-4">--}}
{{--                                    @forelse ($trainee->traineeResume as $resume)--}}
{{--                                        <div class="flex flex-col gap-4">--}}
...
{{--                            <div class="flex flex-col gap-4 w-full lg:w-1/2">--}}
{{--                                <div class="flex flex-col gap-4">--}}
{{--                                    <p class="text-2xl text-[#4984F6] dark:text-white font-semibold">{{ trans('cgo.job_support.ojt_list.trainee_match.trainee_information.expertise') }}</p>--}}
{{--                                    <div class="flex  flex-wrap gap-4">--}}
{{--                                        @foreach (json_decode($trainee->traineeInformation->expertise) as $expertise)--}}
{{--                                            <label--}}
{{--                                                class="text-primary bg-[#F6FBFF] dark:bg-[#282828] px-2 py-1 font-semibold rounded-lg">Web--}}
{{--                                                {{ $expertise->name }}</label>--}}
{{--                                        @endforeach--}}
{{--                                    </div>--}}
...
{{--                            </div>--}}
{{--                            <div class="flex flex-col gap-4 w-full lg:w-1/2">--}}
{{--                                <p class="text-2xl text-[#4984F6] dark:text-white font-semibold">{{ trans('cgo.job_support.ojt_list.trainee_match.trainee_information.language') }}</p>--}}
{{--                                <div class="flex  flex-wrap gap-4">--}}
{{--                                    @foreach (json_decode($trainee->traineeInformation->language) as $language)--}}
{{--                                        <label--}}
{{--                                            class="text-[#CF9090] bg-[#FFF7F7] dark:bg-[#282828] px-2 py-1 font-semibold rounded-lg">{{ $language->name }}</label>--}}
{{--                                    @endforeach--}}
...
{{--                        </div>--}}
                        <div class="flex justify-end">
                            @if ($trainee->isMatchOJT($ojt->id))
                                @if($ojt->getCurrentOJTMatch($ojt->id, $trainee->id)->matched_by != Auth::guard(activeGuard())->user()->id)
                                <button type="button" disabled
                                    class="py-2.5 px-4 text-white bg-[#F34550] hover:bg-red-800 text-sm font-medium rounded-full cursor-not-allowed">{{ trans('cgo.job_support.ojt_list.trainee_match.trainee_information.unmatch_button') }}</button>
                                @else
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-[#1E1E1E] dark:border dark:border-white px-4 py-8">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400 text-center">
                            Are you sure
                            you want to unmatch this trainee?</h3>
