    ...
    <div class="max-w-2xl mx-auto w-screen py-24 flex flex-col h-full justify-start">
        <div
            ...
            <div class="flex flex-col gap-6">
                ...
                @endif
                <form class="leading-5" action="{{ route('trainee.auth.postLogin') }}" method="POST" autocomplete="off">
                    @csrf
                    <div class="mb-6">
                        <label for="email"
            ...
            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 hidden" id="eye-icon-hide">
                ...
                <path d="m10.748 13.93 2.523 2.523a9.987 9.987 0 0 1-3.27.547c-4.258 0-7.894-2.66-9.337-6.41a1.651 1.651 0 0 1 0-1.186A10.007 10.007 0 0 1 2.839 6.02L6.07 9.252a4 4 0 0 0 4.678 4.678Z"></path>
                    ...
                    <div class="flex items-start mb-6">
                        <a href="{{ route('trainee.auth.forgotPassword') }}"
                    ...
                    <button type="submit"
                        ...
                        text-xl px-5 py-3 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mb-4">{{trans('auth.sign_in')}}
                    </button>
{{--                    <div class="text-center">--}}
{{--                        ---OR-----}}
{{--                    </div>--}}
{{--                    <div class="text-sm font-medium text-center text-gray-500 dark:text-gray-300 mt-4">--}}
{{--                        <a href="/trainee/cas/login" class="w-full text-white bg-[#4984F6] hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-full--}}
{{--                        text-xl px-5 py-3 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mb-4">Sign in using SSO</a>--}}
{{--                    </div>--}}
                    <div class="text-sm font-medium text-center text-gray-500 dark:text-gray-300 mt-4">
                        {{trans('auth.dont_have_account')}} <a href="{{ route('trainee.auth.register') }}"
