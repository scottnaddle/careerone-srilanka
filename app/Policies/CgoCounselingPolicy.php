...
class CgoCounselingPolicy
{
    ...
    {
        return $adminUser->can('view_any_counseling::list');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, CgoCounseling $cgoCounseling): bool
    {
        return $adminUser->can('view_counseling::list');
    }
    ...
    {
        return $adminUser->can('create_counseling::list');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, CgoCounseling $cgoCounseling): bool
    {
        return $adminUser->can('update_counseling::list');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, CgoCounseling $cgoCounseling): bool
    {
        return $adminUser->can('delete_counseling::list');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, CgoCounseling $cgoCounseling): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, CgoCounseling $cgoCounseling): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, CgoCounseling $cgoCounseling): bool
    {
