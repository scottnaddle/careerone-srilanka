        ...
        <div class="flex flex-col gap-6">
            ...
            <div class="flex flex-col gap-6 mt-4">
                ...
                <div class="flex flex-col items-center justify-center gap-4">
                    ...
                    <p class="text-primary dark:text-white font-semibold text-center text-base">{{trans('auth.Reset your Trainee account password.')}}</p>
                </div>

                <!-- Right column: Forgot Password form -->
                <div class="w-full flex flex-col items-center justify-center gap-6 md:col-span-2">
                    <form class="w-full flex flex-col gap-4 leading-5" action="{{ route('trainee.auth.postForgotPassword') }}" method="POST" autocomplete="off">
                        @csrf
                        ...
                        <div class="text-sm font-medium text-center text-gray-500 dark:text-gray-300 mt-2">
                            <a href="/trainee/cas/login" class="text-primary hover:underline dark:text-blue-500">{{ trans('auth.sign_in') ?? 'Sign In' }}</a>
                        </div>
                    </form>
                </div>
            </div>
