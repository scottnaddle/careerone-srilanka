...
class PolicyCategoryPolicy
{
    ...
    {
        return $adminUser->can('view_any_policy::category');
    }

    /**
     * Determine whether the adminUser can view the model.
     */
    public function view(AdminUser $adminUser, PolicyCategory $policyCategory): bool
    {
        return $adminUser->can('view_policy::category');
    }
    ...
    {
        return $adminUser->can('create_policy::category');
    }

    /**
     * Determine whether the adminUser can update the model.
     */
    public function update(AdminUser $adminUser, PolicyCategory $policyCategory): bool
    {
        return $adminUser->can('update_policy::category');
    }

    /**
     * Determine whether the adminUser can delete the model.
     */
    public function delete(AdminUser $adminUser, PolicyCategory $policyCategory): bool
    {
        return $adminUser->can('delete_policy::category');
    }
     ...
     */
    public function forceDelete(AdminUser $adminUser, PolicyCategory $policyCategory): bool
    {
     ...
     */
    public function restore(AdminUser $adminUser, PolicyCategory $policyCategory): bool
    {
     ...
     */
    public function replicate(AdminUser $adminUser, PolicyCategory $policyCategory): bool
    {
